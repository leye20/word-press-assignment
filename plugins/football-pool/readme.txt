...
* This plugin requires WordPress 4.7 or higher, PHP 5.3 or higher and jQuery 1.4.3 or higher.
...
= 2.7.2 =
* Bug fix: Changed visibility of admin functions in v2.7.1 caused problems in some extension plugins (thanks croelan for reporting the problem).
